  ...
  return (
    <div className="relative z-20 bg-white text-gray-800">
      <div className="flex flex-col md:flex-row p-6 md:p-10 gap-10 md:gap-0">
        ...
        {/* Quick Links */}
        <div className="flex-1 josefin flex flex-col">
        ...
        {/* Contact Info */}
        <div className="flex-1 josefin flex flex-col space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <span className="font-semibold text-sm md:text-base">+971 50 846 8709</span>
          </div>
          <div className="flex items-start gap-3">
            <img className="h-6 md:h-7" src={emailIcon} alt="email" />
            <span className="font-semibold text-sm md:text-base">jpcs.uae@gmail.com</span>
          </div>
      ...
      <p className="text-center text-xs md:text-base pb-4 josefin font-semibold">
