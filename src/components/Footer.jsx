        ...
        <div className="flex-1  flex flex-col space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className=" text-sm md:text-base">Sales@jpcs.ae</span>
              <span className=" text-sm md:text-base">Info@jpcs.ae</span>
            </div>
          </div>
          <img
            className="h-16 w-16 md:h-20 md:w-20 pt-2 mt-5"
            src={qr}
            alt="QR code"
          />
        </div>
