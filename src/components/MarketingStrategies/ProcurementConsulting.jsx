...
const ProcurementConsulting = () => {
    ...
    return (
        <div className="relative">
                ...
                <div className="h-full bgSVG">
                    <div className="pt-40 text-black flex flex-col md:flex-row justify-center items-center gap-10">
                        <img
                            ...
                            alt=""
                        />
                        <p className="text-lg md:text-xl josefin font-semibold text-center md:text-left max-w-lg leading-relaxed border-l-4 border-black pl-4 italic mt-4 md:mt-0">
                    ...
                    <div className="h-full space-y-16 py-24 md:py-32">
                        <section className="w-full flex flex-col md:flex-row gap-10 justify-center items-center">
                            ...
                            <div id="section2" className="w-full md:w-1/3 h-full josefin space-y-5 justify-center translate-y-50">
                                <p className="font-bold text-xl md:text-2xl text-center">
                        ...
                        <section className="w-full flex flex-col md:flex-row gap-10 justify-center items-center">
                            ...
                            <div id="section4" className="w-full md:w-1/3 h-full josefin space-y-5 justify-center translate-y-50">
                                <p className="font-bold text-xl md:text-2xl text-center">
            ...
            <img src={procImage} className="fixed blur-sm top-0 z-1 w-full h-full object-cover" alt="" />
        </div>
    );
};
