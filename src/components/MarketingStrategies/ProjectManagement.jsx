        ...
        <div className="relative">
            <div className="relative z-8">
                ...
                <div className="h-full bgSVG">
                    <div className="pt-40 text-black flex flex-col md:flex-row justify-center items-center gap-10 px-4 sm:px-8 md:px-16">
                        <img
                            id="projsIcon"
                            src={projsIconImage}
                            className="h-60 sm:h-72 lg:h-80 rounded-lg"
                            alt=""
                        />
                        <p className="text-base sm:text-lg josefin font-semibold text-center md:text-left max-w-lg leading-relaxed border-l-4 border-black pl-4 italic mt-4 md:mt-0">
                    ...
                    <div className="h-full space-y-12 py-24 sm:py-36">
                        <section className="w-full flex flex-col md:flex-row gap-10 justify-center items-center">
                            <div id="section1" className="w-full sm:w-96 h-full josefin space-y-5 justify-center">
                            ...
                            <div id="section2" className="w-full sm:w-96 h-full josefin space-y-5 justify-center translate-y-50">
                                <p className="font-bold text-xl sm:text-2xl text-center">
                        ...
                        <section className="w-full flex flex-col md:flex-row gap-10 justify-center items-center">
                            <div id="section3" className="w-full sm:w-96 h-full josefin space-y-5 justify-center">
                                <p className="font-bold text-xl sm:text-2xl text-center">
                            ...
                            <div id="section4" className="w-full sm:w-96 h-full josefin space-y-5 justify-center translate-y-50">
                                <p className="font-bold text-xl sm:text-2xl text-center">
                                    HOW WE DRIVE SUCCESS
                                </p>
                                <p className="text-center flex flex-col gap-2">
                                    <span className="font-bold">End-to-End Project Solutions</span>
                                    📋 Project Scoping & Planning: Defining goals, timelines, resources, and roles
                                    <br />
                                    🔄 Agile Execution: Monitoring progress, adapting quickly, and removing roadblocks
                                    <br />
                                    🤝 Stakeholder Coordination: Ensuring alignment and accountability at every level
                                    <br />
                                ...
                                <div className="text-center flex flex-col gap-2">
                                    ...
                                    <ul className="list-disc list-inside text-left">
                                        <li>Projects delivered on time, within scope, and on budget</li>
