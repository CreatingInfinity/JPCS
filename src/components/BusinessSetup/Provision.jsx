      ...
      <div className="relative z-8">
        ...
        <div className="h-full bg-linear-to-b from-orange-100 to-white">
          <div className=" pt-40 text-black flex justify-center items-center gap-10">
            ...
            Provision is the backbone of a successful business setup. At JP Consulting & Services, we ensure that your company is equipped with the right tools, templates, and operational systems to function efficiently from day one. Whether you’re launching a startup or restructuring your business, our provision service delivers customized solutions tailored to your industry, goals, and workflow.
             {" "}
             <br />
             <br />
             Our expert team prepares everything you need — from policy drafts and document templates to operational guides and compliance frameworks — so your business is ready to operate, scale, and succeed.
            </p>
          </div>
            ...
            <section className="w-full flex gap-10 justify-center items-center">
              <div id="section1" className="w-120 h-full josefin space-y-5 justify-center">
                ...
                <p className="text-center flex flex-col gap-2">
                  ...
                  At JP Consulting & Services, our Provision service ensures that you have everything in place to start, manage, and grow your business smoothly. From essential tools and templates to operational systems and resource planning, we provide the backbone your business needs to operate with confidence and control.
               </p>
              </div>
              <div id="section2" className="w-120 h-full josefin space-y-5 justify-center translate-y-50">
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">Customized Solutions to Fit Your Setup</span>
                  We don’t believe in generic setups. We take the time to understand the nature of your business and provide provisions tailored to your goals, industry requirements, and operational scale — so you’re always ready to move forward.
                </p>
              </div>
            </section>
            <section className="w-full flex gap-10 justify-center items-center">
              <div id="section3" className="w-120 h-100 josefin space-y-5 justify-center">
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">Structure. Systems. Scalability.</span>
                  The right provisions at the beginning can save time, reduce cost, and avoid unnecessary roadblocks. Our team ensures your business has the right documentation, tools, and infrastructure from day one.
                </p>
              ...
              <div id="section4" className="w-120 h-100 josefin space-y-5 justify-center translate-y-50">
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">Provision Services That Scale With You</span>
                  🛠️ Systematic Setup: Equip your business with necessary tools and processes<br></br>

                  📂 Organized Documentation: Streamline business workflows from the start <br></br>

                  🚀 Scalable Infrastructure: Prepare for growth with future-ready resources<br></br>

                  🤝 Compliance & Readiness: Ensure you're aligned with industry standards and ready to launch
                </p>
                <div className="text-center flex flex-col gap-2">
                  <span className="font-bold">YOUR BENEFITS:</span>
                  <ul className="list-disc list-inside text-left">
                    <li>
                    Faster and smoother business setup process
                    </li>
                    <li>Reduced startup delays and operational confusion</li>
                    <li>
                    Professionally prepared documentation and templates
                    </li>
                    <li>
