        ...
        <div className="h-full bg-linear-to-b from-orange-100 to-white">
          <div className=" pt-40 text-black flex justify-center items-center gap-10">
            ...
            <p className="text-lg josefin font-semibold text-center md:text-left max-w-lg leading-relaxed border-l-4 border-black pl-4 italic">
              ...
              implementing advanced systems tailored to your industry needs.{" "}
              <br />
              <br />
            ...
            <section className="w-full flex gap-10 justify-center items-center">
              ...
              >
                ...
                <p className="text-center flex flex-col gap-2">
                  ...
                  Whether you’re implementing productivity software,
                  industry-specific tools, or enterprise-level systems, we
                  handle the technical setup so you can focus on running your
                  business.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">
                    Customized Solutions, Smooth Implementation
                  </span>
                  We understand that every business uses technology differently.
                  That’s why we assess your specific needs and select the
                  best-fit software — configuring it to align with your
                  operations, team size, and long-term goals. Our approach
            ...
            <section className="w-full flex gap-10 justify-center items-center">
              ...
              >
                ...
                <p className="text-center flex flex-col gap-2">
                  ...
                  Installing new software can be overwhelming — from
                  compatibility checks to licensing, updates, and user access
                  control. Our experienced team manages the entire process,
                  ensuring everything runs smoothly, securely, and in compliance
                  with your IT policies.
                </p>
                <div className="text-center flex flex-col gap-2">
                  <span className="font-bold">WHAT WE INSTALL</span>
                  <ul className="list-disc list-inside text-left">
                    <li>
                      Business & Productivity Suites (e.g., Microsoft 365,
                      Google Workspace)
                    </li>
              ...
              >
                ...
                <p className="text-center flex flex-col gap-2">
                  ...
                  🔧 System Assessment & Compatibility Checks
                  <br />
                  💻 Secure Installation & Configuration
                  <br />
                  👥 User Setup & Access Management
                  <br />
