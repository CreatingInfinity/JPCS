          ...
          <div className="h-full space-y-50 py-100">
            <section className="w-full flex gap-10 justify-center items-center">
              <div id="section1" className="w-120 h-full josefin space-y-5 justify-center">
                ...
                <p className="text-center flex flex-col gap-2">
                  ...
                  At JP Consulting & Services, we offer advanced security system solutions designed to safeguard your assets, people, and operations. Whether you're setting up a new business or upgrading your existing security infrastructure, we provide customized systems that bring peace of mind and 24/7 protection.
              ...
              <div id="section2" className="w-120 h-full josefin space-y-5 justify-center translate-y-50">
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">Customized Security That Fits Your Needs</span>
                  We understand that every business is different — from retail stores and corporate offices to warehouses and facilities. That’s why we tailor our security solutions to your space, risks, and goals. Our team ensures a smooth setup, seamless integration, and ongoing support.
            ...
            <section className="w-full flex gap-10 justify-center items-center">
              <div id="section3" className="w-120 h-100 josefin space-y-5 justify-center">
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">Proactive Planning, Real-Time Protection</span>
                  Security isn’t just about cameras and alarms — it’s about planning, prevention, and control. We assess vulnerabilities, anticipate threats, and design systems that not only detect, but deter unauthorized access and incidents.
                </p>
                <div className="text-center flex flex-col gap-2">
                  <span className="font-bold">SOLUTIONS WE PROVIDE
                  </span>
              ...
              <div id="section4" className="w-120 h-100 josefin space-y-5 justify-center translate-y-50">
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">End-to-End Security Services</span>
                  🔍 Site Assessment & Risk Evaluation<br />
                  🛠 Custom System Design & Installation<br />
                  🔒 Smart Integration with Existing Infrastructure<br />
                  📲 Remote Monitoring & Management Solutions<br />
                ...
                <div className="text-center flex flex-col gap-2">
                  ...
                  <ul className="list-disc list-inside text-left">
                    <li>
                    Enhanced protection for physical and digital assets
                    </li>
                    <li>Deterrence of theft, intrusion, and unauthorized access</li>
                    <li>
                    24/7 monitoring for quick incident response
                    </li>
                    <li>
