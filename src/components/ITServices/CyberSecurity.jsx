          ...
          <div className="h-full space-y-50 py-100">
            <section className="w-full flex gap-10 justify-center items-center">
              ...
              >
                ...
                <p className="text-center flex flex-col gap-2">
                  <span className="font-bold">
                    Tailored Protection for Your Business Environment
                  </span>
            ...
            <section className="w-full flex gap-10 justify-center items-center">
              ...
              >
                ...
                <div className="text-center flex flex-col gap-2">
                  <span className="font-bold">
                    CYBERSECURITY PAIN POINTS WE SOLVE
                  </span>
                  <ul className="list-disc list-inside text-left">
                    <li>Protecting sensitive customer and company data</li>
                    <li>Preventing unauthorized access and data breaches</li>
                    <li>
                      Ensuring compliance with security regulations and
                      standards
                    </li>
                    <li>
                      Managing risk across networks, cloud services, and remote
                      teams
                    </li>
              ...
              >
                ...
                <p className="text-center flex flex-col gap-2">
                  ...
                  🔒 Risk Assessment & Audits: Evaluate current security posture
                  and gaps
                  <br />
                  🧰 Threat Detection & Monitoring: Implement real-time systems
                  to identify and respond to threats
                  <br />
                  🛡 Data Protection Strategies: Secure your most valuable assets
                  with encryption, backup, and access control
                  <br />
                  📘 Policy Development & Training: Educate your team and build
                  a strong internal security culture
                  <br />
                  🚨 Incident Response Plans: Be ready to respond when the
                  unexpected happens
                </p>
                <div className="text-center flex flex-col gap-2">
                  ...
                  <ul className="list-disc list-inside text-left">
                    ...
                    <li>
                      Compliance with security laws and industry regulations
                    </li>
                    <li>
