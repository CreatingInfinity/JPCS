...
const ContactUsFooter = () => {
  return (
    <div className="min-h-screen bgSVG2 relative z-20 px-6 py-20 bg-gray-200 ">
      {/* Header */}
      ...
      <div className="mx-auto max-w-5xl bg-transparent backdrop-blur-sm bg-linear-to-r from-orange-400/70 to-orange-400/70 rounded-xl p-10 shadow-lg">
        <div className="flex flex-col md:flex-row gap-10">
          {/* Left Column: Text */}
          <div className="flex-1 space-y-4 text-gray-800 text-sm lg:text-lg font-medium text-center leading-relaxed">
          ...
          <div className="flex flex-col md:justify-center md:items-start items-center gap-5 w-full font-josefin font-semibold md:w-auto">
            <Link
              to="/Contact"
              className="px-7 py-2 border border-gray-800 rounded-full cursor-pointer hover:bg-orange-500 hover:text-white transition-all duration-300 text-base bg-white text-black"
            >
              Contact Us
            </Link>
            <Link
