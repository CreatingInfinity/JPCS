  ...
  return (
    <div className="h-auto bgSVG2 relative z-10 px-4 sm:px-6 py-8 md:py-12 bg-gray-100">
      ...
      <div className="text-center mb-8 md:mb-12 select-none">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mt-2 md:mt-4 font-light ">
      ...
      <div className="mx-auto w-full max-w-6xl bg-transparent backdrop-blur-sm bg-linear-to-r from-orange-400/70 to-orange-400/70 rounded-xl p-6 md:p-10 shadow-lg">
        <div className="flex flex-col md:flex-row gap-8 md:gap-10">
          {/* Left Column: Text */}
          <div className="flex-1 space-y-4 text-gray-800 text-sm sm:text-base lg:text-lg font-regular leading-relaxed">
          ...
          <div className="flex flex-col md:justify-center md:items-start items-center gap-4 w-full md:w-auto">
            <Link
              to="/Contact"
              reloadDocument
              className="px-6 py-2 w-full text-center  rounded-full cursor-pointer hover:bg-orange-500 hover:text-white transition-all duration-300 text-sm bg-white text-black"
            >
              Contact Us
            </Link>
            <Link
            reloadDocument
              to="/About"
              className="px-6 py-2 rounded-full cursor-pointer hover:bg-orange-500 hover:text-white transition-all duration-300 text-sm bg-white text-black"
            >
              More About Us
            </Link>
          </div>
